...
| `tiller-summary` | `gpt-5.4-mini`, `model_reasoning_effort = "medium"`, read-only | scrutiny | Compact status updates, distilled ambient state, run ledger summaries, stale/late report triage, checkpoint candidate synthesis |
