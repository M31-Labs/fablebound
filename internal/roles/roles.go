// Package roles provides the default role prompt files for fablebound agents.
// Each role is a markdown file loaded via go:embed. Projects may override
// individual roles by placing .fablebound/roles/<role>.md in the project dir.
package roles
...
// KnownRoles is the canonical list of fablebound role names.
...
// .fablebound/roles/<role>.md in projectDir over the embedded default.
...
// Used by fablebound init to materialize role prompts.
